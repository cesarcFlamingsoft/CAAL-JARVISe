...
async def generate_reply(history, text, *, home=None):
    ...
    context.add_message(
        ...
        "Before any home.light call, read home.states for lights in this turn. Only use an "
        "exact entity_id returned by home.states; never infer, abbreviate, or invent an ID. "
        "If more than one returned light fits the request, ask which one. home.light operates "
        "explicitly requested lights only. Never operate locks, "
